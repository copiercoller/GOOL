...
public final class JsPlatform extends Platform {
	...
	private final String outputDir = Settings.get("js_out_dir");

	private JsPlatform(Collection<File> myFile) {
		super("JS", myFile);
	}

	@Override
	protected CodePrinter initializeCodeWriter() {
		return new JsCodePrinter(new File(outputDir), myFileToCopy);
	}
	...
	private static JsPlatform instance = new JsPlatform(myFileToCopy);

	public static JsPlatform getInstance(Collection<File> myF) {
		myFileToCopy = myF;
		return instance;
	}

	public static JsPlatform getInstance() {
	...
	public static void newInstance() {
		instance = new JsPlatform(myFileToCopy);
	}
}
